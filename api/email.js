                        ...
                        let info = MAIL.sendMail({
                            ...
                            <body style="background-color: #ffffff;">
                                <div style="position: absolute; top: 20%; left: 40%;">
                                    <div style="height: 284px; width: 350px; background-color: #000000; border-radius: 5%;">
                                        <div>
                                            <h2 style=" color: #4280EF; padding-left: 3%;">¿Eres tu el que ha <br> iniciado sesión?
                                                </h2>
                                        </div>
                                        <div style="text-align: center; margin-top: 20px;">
                                            <button type="button"
                                                style=" color: #ffffff; background-color: #4280EF; border-radius: 5px; height: 30px; width: 250px; border: none;">Si, soy yo</button>
                                        </div>
                                        <footer
                                            style="position: fixed-bottom; height: 13%; width: 100%; background-color: #4280EF; text-align: center; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                                            <h5 style="color: #ffffff;">Contacto: sublisivarte@email.com</h5>
                                        </footer>
                                    </div>
                                </div>
                            </body>
